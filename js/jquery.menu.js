  ...
  $.fn.createMenu = function() {
    return this.each(function() {
      ...
      var initializer = function() {
        offset = (Modernizr.flexbox) ? null : navbar.position().left;
        ...
        submenus.filter('div').each(function() {
          ...
          if ($(this).parent().position().left - offset < panel.children('div').outerWidth()) {
      ...
      /*var updatePosition = function() {
        offset = (Modernizr.flexbox || panel.css('position') == 'fixed') ?
            null : navbar.position().left;
        panel.offset({ left: offset });
